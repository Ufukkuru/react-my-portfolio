...
<div className="  sm:flex justify-center items-center" >
    <div className="max-w-sm mb-4 p-6 mx-3 sm:mx-3 sm:w-96 bg-transparent border-2 border-white rounded-lg shadow shadow-white">
    ...
    <div className="sm:max-w-full mb-4 p-6 mx-3 sm:mx-3 sm:w-96 bg-transparent border-2 border-white rounded-lg shadow shadow-white">
